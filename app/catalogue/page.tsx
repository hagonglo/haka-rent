...
export default async function CataloguePage({ searchParams }: { searchParams: Promise<{ categorie?: string }> }) {
  ...
  return <main className="catalogue-page"><SiteHeader /><section className="catalogue-hero"><div className="page-shell"><p className="eyebrow">Matériel</p><h1 className="catalogue-title">Catalogue</h1></div></section><CatalogueClient initialCategory={initialCategory} /></main>;
}
